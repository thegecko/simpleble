...
cmake $DEBUG_ARG -H$SOURCE_PATH -B $BUILD_PATH -DCMAKE_SYSTEM_NAME=iOS -DCMAKE_OSX_ARCHITECTURES=arm64 -DCMAKE_OSX_DEPLOYMENT_TARGET=15.8 -DBUILD_SHARED_LIBS=ON $BUILD_TEST_ARG $BUILD_SANITIZE_ADDRESS_ARG $BUILD_SANITIZE_THREAD_ARG $BUILD_SHARED_ARG $BUILD_PLAIN $BUILD_EXCLUDE_C $EXTRA_BUILD_ARGS
