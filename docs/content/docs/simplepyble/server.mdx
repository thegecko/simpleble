---
title: REST Server
description: Comprehensive documentation for the SimplePyBLE REST server API.
---

SimplePyBLE includes a built-in REST server that allows you to control BLE devices using a REST API. This is particularly useful for controlling BLE devices remotely or for providing an interface for AI agents.

## Installation

To use the server, you need to install the optional dependencies:
...
- **Response**: 
  ```json
  {"message": "SimplePyBLE API is running"}
  ```
