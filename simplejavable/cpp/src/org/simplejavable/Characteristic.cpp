...
Characteristic::Characteristic(const SimpleJNI::String<SimpleJNI::LocalRef>& uuid,
    ...
    _obj = SimpleJNI::Object<SimpleJNI::ReleasableLocalRef>::call_new_object(
        ...
        uuid.get(),
        descriptors.get(),
        static_cast<jboolean>(canRead),
        static_cast<jboolean>(canWriteRequest),
        static_cast<jboolean>(canWriteCommand),
        static_cast<jboolean>(canNotify),
        static_cast<jboolean>(canIndicate)
    );
}

Characteristic::operator SimpleJNI::Object<SimpleJNI::ReleasableLocalRef, jobject>() const {
    return _obj;
}
